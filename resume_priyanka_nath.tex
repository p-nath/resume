...
\indent{- Implemented a Naive Bayes Classifier from scratch for handwritten digits from MNIST digit dataset.}\\% with an accuracy\\\indent rating of .}\\

\indent\textbf{Principle Component Ananlysis using GPU}\\
