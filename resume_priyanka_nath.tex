...
{Research Intern under the Summer Internship Program in Cryptology 2017,}\\
{under the initiative of \emph{R. C. Bose Centre for Cryptology and Security}, Indian Statistical Institute,}\\
{funded by the \emph{‘Rx Lab Program’} of Microsoft Research India.}\\
\end{tabular*}\\\\
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\textbf{Linux System Call Analysis Application – } Indian Statistical Institute
& \small{\emph{May, 2017 - July, 2017}}\\
\end{tabular*}
\indent{- Created a linux system call pattern matching application in Python for the Defence Research and\\
\indent{Development Organisation(DRDO) which uses American Fuzzy Lop(AFL) generated inputs to check for}\\
\indent{ vulnerabilities in a software/executable.}\\
...
\indent\textbf{Principal Component Analysis using GPU}\\
\indent{- Implemented dimensionality reduction by applying PCA on Iris dataset using CUDA-C.}\\
...
\indent\textbf{Bookmarkz: A Social Bookmarking App in Python}\\
\indent{- Developed a social bookmarking app using Django web framework where a user can create an account,\\ 
\indent share bookmarks, vote on shared bookmarks, etc.}\\

\indent\textbf{MysticSquare: An Android Game}\\
\indent{- Created a basic Mystic-Square(also known as 15 puzzle) game for Android using Android Studio.}\\\\


\resheading{\textbf{Technical Skills} }\\\\[\lsep]

\indent\textbf{Programming -- }Coded mainly in \textbf{C, Python.} Proficient in coding with C++ and Java.\\
\indent\textbf{Web -- } HTML, CSS, Javascript.\\
\indent\textbf{Developement Tools --} Android Studio \& Android SDK, MySQL \& Oracle.\\
\indent\textbf{Others -- } Familiar with Python's scikit-learn library, Latex. \\\\
